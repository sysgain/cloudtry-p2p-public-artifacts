...
$invokeUrl = 'https://sxmguodehi.execute-api.us-west-2.amazonaws.com/prod/fortwebkeylic/'+ $Tdid +'/licreserve'
$response = Invoke-RestMethod $invokeUrl -Method Put -Body $json -ContentType 'application/json'
